...
public class DeviceControlActivity extends Activity implements SensorEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sensor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // Intent page = new Intent (DeviceControlActivity.this,SensorValues.class);
               // startActivity(page);
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        xText.setText(String.valueOf(Math.round(event.values[0]*100)/100));
        yText.setText((int) event.values[1]);
        zText.setText("Z:"+ String.valueOf(event.values[2]));
    }
